...
1. In the left sidebar, select **Search** <img src="../.gitbook/assets/databases-analytics-and-search/search-people-vehicles-search-icon.png" alt="Search magnifying glass icon in the sidebar." height="18">.
