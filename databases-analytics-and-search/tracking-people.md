...
Use the minimum PPF values in the table when you plan each camera or zone. Person tracking needs 18 PPF; face recognition needs the highest value. Add margin when lighting is poor, the angle is steep, or the scene is crowded.
