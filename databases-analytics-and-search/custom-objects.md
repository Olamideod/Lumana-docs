...
1. In the left sidebar, select **Alerts** <img src="../.gitbook/assets/databases-analytics-and-search/custom-objects-alert-icon.png" alt="" height="18">.

2. Select **Add alert**.

<div align="center" data-with-frame="true"><img src="../.gitbook/assets/databases-analytics-and-search/custom-objects-alerts-monitoring-add-alert.png" alt="" width="900"></div>

3. Under **Identification**, find the **Missing object** template and select **Use template**.

<div align="center" data-with-frame="true"><img src="../.gitbook/assets/databases-analytics-and-search/custom-objects-missing-object-template.png" alt="" width="900"></div>
...
<div align="center" data-with-frame="true"><img src="../.gitbook/assets/databases-analytics-and-search/custom-objects-missing-object-alert-config.png" alt="" width="720"></div>

6. Select **Cameras** and select the camera (or cameras) that should watch the object.

<div align="center" data-with-frame="true"><img src="../.gitbook/assets/databases-analytics-and-search/custom-objects-choose-cameras-edit.png" alt="" width="900"></div>

7. Select the pencil icon <img src="../.gitbook/assets/databases-analytics-and-search/custom-objects-edit-pencil-icon.png" alt="" height="18"> next to the camera so you can mark the object the alert should track.

<div align="center" data-with-frame="true"><img src="../.gitbook/assets/databases-analytics-and-search/custom-objects-mark-object-dialog.png" alt="" width="720"></div>

8. In the **Mark object** dialog, outline the object, then select **Select**.

9. When the rest of the rule is complete, select **Create alert** <img src="../.gitbook/assets/databases-analytics-and-search/custom-objects-create-alert-button.png" alt="" height="32">.
...
<div align="center" data-with-frame="true"><img src="../.gitbook/assets/databases-analytics-and-search/custom-objects-missing-object-alert-monitoring-example.png" alt="" width="900"></div>

Select the alert to open a video clip or image for that event.

<div align="center" data-with-frame="true"><img src="../.gitbook/assets/databases-analytics-and-search/custom-objects-missing-object-video-preview.png" alt="" width="900"></div>

From the preview, you can save footage to the archive with the archive icon <img src="../.gitbook/assets/databases-analytics-and-search/custom-objects-archive-icon.png" alt="" height="18">, or select **Share** <img src="../.gitbook/assets/databases-analytics-and-search/custom-objects-share-icon.png" alt="" height="18"> to share the clip according to your organization's policy.
