...
<div align="center" data-with-frame="true"><img src="../.gitbook/assets/people-directory-profiles.png" alt="Organization database people directory showing unsaved people, saved profiles, and search controls."></div>
...
1.  In the people directory, click **Create group**.
    ...
    <div align="center" data-with-frame="true"><img src="../.gitbook/assets/people-directory-groups.png" alt="People directory groups view with Create group button and group list."></div>
2.  Enter a group name and select the profiles to include.

    The dialog shows the selected people before you save the group.

    <div align="center" data-with-frame="true"><img src="../.gitbook/assets/create-group-dialog.png" alt="Create a group dialog with group name field, searchable people list, and Create button."></div>
3.  Save the group.

    You can later hover over the group to edit or delete it.

    <div align="center" data-with-frame="true"><img src="../.gitbook/assets/people-groups-table-edit-delete.png" alt="Groups table with group names, member counts, and edit and delete actions."></div>
...
<div align="center" data-with-frame="true"><img src="../.gitbook/assets/vehicles-directory-vehicles.png" alt="Vehicles directory showing seen vehicles, add manually option, and existing vehicle records."></div>
...
2.  Enter the owner name and verify the vehicle details.
    ...
    <div align="center" data-with-frame="true"><img src="../.gitbook/assets/vehicle-seen-validation-dialog.png" alt="Vehicle validation dialog with owner name, license plate, make, color, and Add button."></div>
3.  Click **Add**.
...
4.  If needed, add a vehicle manually by uploading an image and entering the relevant details.
    ...
    <div align="center" data-with-frame="true"><img src="../.gitbook/assets/vehicle-manual-upload-form.png" alt="Manual vehicle upload form with image upload area and vehicle detail fields."></div>
...
4.  If you are creating a license plate alert, you can also select **Import from file** in the alert flow.
    ...
    <div align="center" data-with-frame="true"><img src="../.gitbook/assets/license-plate-import-from-file-dialog.png" alt="License plate dialog with vehicle list, Import from file option, and action buttons."></div>
...
<div align="center" data-with-frame="true"><img src="../.gitbook/assets/event-tag-configuration-fields.png" alt="Event tag setup showing name, clip length, and custom field configuration."></div>

<div align="center" data-with-frame="true"><img src="../.gitbook/assets/organization-database-event-tags.png" alt="Organization database Event tags view with create action, tag count, and tag list."></div>
