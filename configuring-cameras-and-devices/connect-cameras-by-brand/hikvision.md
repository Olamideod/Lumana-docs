...
- Flexibility: Easily modify or revoke Lumana Core's access without affecting the admin user’s settings or the access of other users.
Customized Access Levels: Tailor the access rights of the profile to match the exact requirements of Lumana Core, ensuring it has only the necessary permissions, thus enhancing the overall security posture.
