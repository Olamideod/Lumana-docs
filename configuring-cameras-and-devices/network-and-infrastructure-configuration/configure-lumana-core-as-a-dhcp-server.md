...
Click on ![Cameras icon in the sidebar.](../../.gitbook/assets/configuring-cameras-and-devices/network-and-infrastructure-configuration/dhcp-sidebar-cameras-icon.png) here

Go to the core where you want to enable DHCP server and click ![Edit pencil icon.](../../.gitbook/assets/configuring-cameras-and-devices/network-and-infrastructure-configuration/dhcp-edit-pencil-icon.png) to edit core

![Cores list, edit core.](../../.gitbook/assets/configuring-cameras-and-devices/network-and-infrastructure-configuration/dhcp-edit-core-location.png)

Go to "DHCP Server" configuration and fill your parameters

![DHCP Server configuration form.](../../.gitbook/assets/configuring-cameras-and-devices/network-and-infrastructure-configuration/dhcp-server-configuration-form.png)
...
![Example DHCP Server configuration with sample values.](../../.gitbook/assets/configuring-cameras-and-devices/network-and-infrastructure-configuration/dhcp-example-configuration-filled.png)
...
![DHCP Server with address reservations and attached devices.](../../.gitbook/assets/configuring-cameras-and-devices/network-and-infrastructure-configuration/dhcp-address-reservation-ui.png)