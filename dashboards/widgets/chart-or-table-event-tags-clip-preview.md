...
<div align="center"><img src="../../.gitbook/assets/dashboards/widget-event-tags-clip-preview-images-tab.png" alt="Event tag clip preview with the Images tab selected, showing still frames, a timeline scrubber, and playback controls below the viewer." width="480"></div>
...
<div align="center"><img src="../../.gitbook/assets/dashboards/widget-event-tags-clip-preview-video-tab.png" alt="Same clip preview with the Video tab selected and video paused." width="480"></div>
...
<div align="center"><img src="../../.gitbook/assets/dashboards/widget-event-tags-clip-playback-controls.png" alt="Playback bar showing previous alert, next alert, play, previous captured image, and next captured image controls." width="480"></div>
...
<div align="center"><img src="../../.gitbook/assets/dashboards/widget-event-tags-clip-overlay-zoom-snapshot-fullscreen.png" alt="Floating toolbar showing zoom out, reset zoom, zoom in, snapshot, and fullscreen controls." width="480"></div>
...
<div align="center"><img src="../../.gitbook/assets/dashboards/widget-event-tags-clip-preview-images-icons.png" alt="Images tab with two camera feeds, playback bar, timeline, and side toolbar icons." width="480"></div>
...
<div align="center"><img src="../../.gitbook/assets/dashboards/widget-event-tags-clip-create-archive.png" alt="Create archive dialog with name field, From and To time fields, duration, Add to case option, and Create button." width="480"></div>
...
<div align="center"><img src="../../.gitbook/assets/dashboards/widget-event-tags-clip-choose-cameras.png" alt="Choose cameras dialog with a search field, location groups, camera list, and a Select button." width="480"></div>
...
<div align="center"><img src="../../.gitbook/assets/dashboards/widget-event-tags-clip-change-layout.png" alt="Change layout menu showing tile count options 1 through 9 and a multi-camera grid preview." width="480"></div>
...
<div align="center"><img src="../../.gitbook/assets/dashboards/widget-event-tags-clip-multi-camera-view.png" alt="Clip preview showing two camera feeds side by side on the Video tab with shared playback controls at the bottom." width="480"></div>
...
<img src="../../.gitbook/assets/dashboards/widget-event-tags-clip-video-inactivity-warning.png" alt="Video tab with an overlay that says the video will pause in a few seconds due to inactivity, with Keep playing and Pause video buttons." width="400">
</td>
<td width="50%" align="center">
<p><strong>Paused — resume playback</strong></p>
<img src="../../.gitbook/assets/dashboards/widget-event-tags-clip-video-inactivity-paused.png" alt="Video tab after inactivity pause, showing Video paused due to inactivity and a Resume video button." width="400">
</td>
</tr>
</tbody>
</table>