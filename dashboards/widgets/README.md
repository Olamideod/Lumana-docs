...
<div align="center"><img src="../../.gitbook/assets/dashboards/main/add-widget-dropdown-image.png" alt="" width="480"></div>

## Widget types

| Widget | What it does |
|---|---|
| [Chart or table](chart-or-table.md) | Visualizes object detections, alert counts, or event tags as a chart or table. |
| [Heatmap](heatmap.md) | Shows where activity is concentrated in a camera's field of view. |
| [Occupancy](occupancy.md) | Tracks how many people are in a space at any point in time. |
