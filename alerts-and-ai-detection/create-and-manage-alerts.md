...
* Select **Alert groups** to group related alerts and manage them together. Follow the steps in [Alert group](alert-group.md).

## Create an alert

1. From the Alerts monitoring view, select **Add alert** in the top right corner. The Configure alerts page opens.

<div><figure><img src="../.gitbook/assets/add-alerts-button.png" alt="" width="375"><figcaption></figcaption></figure><figure><img src="../.gitbook/assets/add-alerts-configure-page.png" alt="" width="375"><figcaption></figcaption></figure></div>
