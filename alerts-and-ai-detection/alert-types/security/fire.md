...
Lumana's fire detection alert triggers when flames are visible in the camera feed. It works as a visual detection layer alongside your existing smoke or fire alarm systems, covering areas that physical sensors may not reach.
