...
Lumana continuously monitors the connection status of all registered cameras and Core devices. When a device loses its connection or comes back online, the alert triggers and sends a notification. You can configure alerts for specific devices or apply them across your entire organization.
