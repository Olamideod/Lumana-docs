...
Holding a phone detection triggers when a person in the camera view holds a cell phone for longer than a duration you set.

## How it works

Set a minimum detection time. Lumana monitors the camera feed and triggers the alert when a person holds a cell phone past the configured duration.
...
6. Select the **seconds** field and choose **seconds**, **minutes**, or **hours**.
