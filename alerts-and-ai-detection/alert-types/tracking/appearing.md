...
3. Select **Tracking** in the left sidebar to go to that section, then select **Use template** on the **Appearing** card. The Create appearing page opens.
...
6. Select the **zone** field to open the Choose cameras modal. Select the cameras you want to monitor, then confirm your selection.
