...
Draw a line across the camera frame and choose which direction of crossing to monitor: left to right, right to left, or both. When an object of the configured type crosses the line in the specified direction, the alert triggers and a clip is recorded.
