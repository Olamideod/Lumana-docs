...
{% hint style="info" %}
If you record to NAS for more than 30 days and want to keep smart search functionality, you need an additional NAS license. No license is needed for the first 30 days.
{% endhint %}
