...
5. Select the <img src="../.gitbook/assets/set-up-cameras-and-devices/set-up-a-camera-floor-plan/floor-plan-add-camera-icon.png" alt="Add camera" data-size="line"> icon in the top right corner to start adding and positioning your cameras on the floor plan
