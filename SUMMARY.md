...
* [Enable PTZ control](configuring-cameras-and-devices/enable-ptz-control.md)
...
* [Connect cameras by brand](configuring-cameras-and-devices/connect-cameras-by-brand/README.md)
  * [Supported cameras](configuring-cameras-and-devices/connect-cameras-by-brand/supported-cameras.md)
  * [Lumana](configuring-cameras-and-devices/connect-cameras-by-brand/lumana.md)
  * [AXIS](configuring-cameras-and-devices/connect-cameras-by-brand/axis.md)
...
* [Other devices](configuring-cameras-and-devices/other-devices/README.md)
  ...
  * [Disruptive sensors](configuring-cameras-and-devices/other-devices/disruptive-sensors.md)
  * [Smart speakers](configuring-cameras-and-devices/other-devices/smart-speakers.md)
  * [GPIO devices](configuring-cameras-and-devices/other-devices/gpio-devices.md)
* [Network and infrastructure configuration](configuring-cameras-and-devices/network-and-infrastructure-configuration/README.md)
  * [Lumana Core hardware specifications](configuring-cameras-and-devices/network-and-infrastructure-configuration/lumana-core-hardware-specifications.md)
  * [Firewall requirements](configuring-cameras-and-devices/network-and-infrastructure-configuration/firewall-requirements.md)
  * [Configure Lumana Core as a DHCP server](configuring-cameras-and-devices/network-and-infrastructure-configuration/configure-lumana-core-as-a-dhcp-server.md)
  * [Local time and NTP configuration](configuring-cameras-and-devices/network-and-infrastructure-configuration/local-time-and-ntp-configuration.md)
...
* [Live view](live-video-monitoring-and-operations/live-view.md)
...
* [The system health dashboard](live-video-monitoring-and-operations/the-system-health-dashboard.md)
...
* [Alert types](alerts-and-ai-detection/alert-types/README.md)
  * [Security](alerts-and-ai-detection/alert-types/security/README.md)
    * [Motion](alerts-and-ai-detection/alert-types/motion.md)
    * [Tampering](alerts-and-ai-detection/alert-types/tampering.md)
    * [Proximity](alerts-and-ai-detection/alert-types/proximity.md)
    * [Trespassing](alerts-and-ai-detection/alert-types/trespassing.md)
    * [Tailgating](alerts-and-ai-detection/alert-types/tailgating.md)
    * [Zone protection](alerts-and-ai-detection/alert-types/zone-protection.md)
    * [Gun detection](alerts-and-ai-detection/alert-types/gun-detection.md)
    * [Speed control](alerts-and-ai-detection/alert-types/speed-control.md)
    * [Door state change](alerts-and-ai-detection/alert-types/doors.md)
    * [Fire](alerts-and-ai-detection/alert-types/fire.md)
    * [Fall detection](alerts-and-ai-detection/alert-types/fall.md)
    * [Violence](alerts-and-ai-detection/alert-types/violence.md)
    * [Suspect alerts](alerts-and-ai-detection/alert-types/suspect-alerts.md)
    * [Gun brandished](alerts-and-ai-detection/alert-types/gun-drawn.md)
  * [Identification](alerts-and-ai-detection/alert-types/identification/README.md)
    * [Face recognition](alerts-and-ai-detection/alert-types/suspect-alerts.md)
    * [License plate recognition](alerts-and-ai-detection/alert-types/license-plate.md)
    * [Container detection](alerts-and-ai-detection/alert-types/container.md)
  * [Tracking](alerts-and-ai-detection/alert-types/tracking/README.md)
    * [Appearing](alerts-and-ai-detection/alert-types/appearing.md)
    * [Disappearing](alerts-and-ai-detection/alert-types/disappearing.md)
    * [Traffic control](alerts-and-ai-detection/alert-types/traffic-control.md)
    * [Occupancy](alerts-and-ai-detection/alert-types/occupancy.md)
    * [Loitering](alerts-and-ai-detection/alert-types/loitering.md)
    * [Line crossing](alerts-and-ai-detection/alert-types/line-crossing.md)
    * [Missing object](alerts-and-ai-detection/alert-types/missing-object.md)
    * [Absence](alerts-and-ai-detection/alert-types/absence.md)
  * [Status](alerts-and-ai-detection/alert-types/status/README.md)
    * [Device status](alerts-and-ai-detection/alert-types/device-status.md)
  * [Safety and compliance](alerts-and-ai-detection/alert-types/safety-and-compliance/README.md)
    * [Protective gear](alerts-and-ai-detection/alert-types/protective-gear.md)
    * [Personal safety](alerts-and-ai-detection/alert-types/personal-safety.md)
    * [Gloves](alerts-and-ai-detection/alert-types/gloves.md)
    * [Hands detected](alerts-and-ai-detection/alert-types/suspect-alerts.md)
    * [Smoking and vaping](alerts-and-ai-detection/alert-types/smoking-and-vaping.md)
  * [Integrations](alerts-and-ai-detection/alert-types/integrations/README.md)
    * [Door tailgating](alerts-and-ai-detection/alert-types/tailgating.md)
