...
Make sure you can access the camera, alert, search result, or archive you want to share. If you want to send the share directly from Lumana, then have the recipient's email address or phone number ready.
...
2. Select the archive you want to share.
   ...
   If it is not in the list yet, then select **Create archive** in the upper right. Finish the archive workflow, then return to **Archives**.
...
3. Complete the steps in [Create link and copy or send](#create-link-and-copy-or-send). On **Share camera**, use **Access to camera for** instead of **Access to video for**, and skip the **Allow to download** step.
...
3. Complete the steps in [Create link and copy or send](#create-link-and-copy-or-send). **Share alert** matches **Share archive** on **Create link**, including **Access to video for** and **Allow to download**.

## Share search results

Use this option when you want to share a clip based on search results.

1. Run your search and select the thumbnail or row for the footage you want. For search-specific steps, see one of the search guides linked in [Next steps](#next-steps).
2. Select **Create archive**, finish saving the clip, then select **Share** so **Share archive** opens.

Continue with the steps in [Create link and copy or send](#create-link-and-copy-or-send). To send by email or SMS from **Existing links**, use [Send the link by email or SMS](#send-the-link-by-email-or-sms).
...
- Use [Search video footage for people or vehicles](../databases-analytics-and-search/search-video-footage-for-people-or-vehicles.md), [Filter people, faces, vehicles, and license plates from the camera view](../databases-analytics-and-search/search-video-footage-for-other-objects.md), or [Free text search](../databases-analytics-and-search/free-text-search.md) to find the clip you want to share.
