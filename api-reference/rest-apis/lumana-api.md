...
The Lumana API currently supports event tag ingestion. The full endpoint reference, including request fields, response schemas, error codes, and a cURL example, is described in the OpenAPI document bundled with this documentation: [lumana-openapi.yaml](../../lumana-openapi.yaml).
